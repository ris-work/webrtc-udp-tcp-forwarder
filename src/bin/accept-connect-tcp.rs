...
async fn configure_send_receive_tcp(
    ...
    RTCPC.on_data_channel(Box::new(move |d: Arc<RTCDataChannel>| {
        let (OtherSocketSendQueue_tx, OtherSocketSendQueue_rx): (Sender<AlignedMessage>, Receiver<AlignedMessage>) = unbounded::<AlignedMessage>();
        ...
        Box::pin({
            ...
            async move {
                ...
                d.on_open(Box::new({
                    ...
                    move || {
                        let (WebRTCSendQueue_tx, WebRTCSendQueue_rx): (Sender<AlignedMessage>, Receiver<AlignedMessage>) = unbounded::<AlignedMessage>();
                        #[cfg(feature = "queuemon")]
                        {
